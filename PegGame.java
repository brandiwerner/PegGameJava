    ...
    public static void PlayGame(Board playboard)
    {
        ...
        do{	
			...
			*/	temp = game.play.get(i);	// Get the current play to try
			...
			// Check for change
            if(newBoard.boardPos[temp[0]] == 'x' && newBoard.boardPos[temp[1]] == 'x' && newBoard.boardPos[temp[2]] == '.')
            {
                ...
                if(newBoard.piecesLeft < 2)
                {
				   ...
				   // Go through and print the board
					...
					Board boardNew = new Board(newBoard.startP + 1);
